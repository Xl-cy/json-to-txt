...
class BDD_to_YOLOv5:
    def __init__(self):
        self.writepath = "C:/Users/10604/Desktop/dataset/bdd100k/labels_txt/train/"
        self.bdd100k_width_ratio = 1.0 / 1280
        self.bdd100k_height_ratio = 1.0 / 720
        self.select_categorys = ["person", "rider", "car", "bus", "truck", "bike",
                                 "motor", "traffic light","traffic sign", "train"]
        self.categorys_nums = {
            "person": 0,"rider": 1,"car": 2,"bus": 3,"truck": 4,"bike": 5,"motor": 6,
            "tl_green": 7,"tl_red": 8,"tl_yellow": 9,"tl_none": 10,"traffic sign": 11,
            "train": 12
        }
...
if __name__ == "__main__":
    bdd_labels_dir = "C:/Users/10604/Desktop/dataset/bdd100k/labels/train/" #存放标签文件夹地址
